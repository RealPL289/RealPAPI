📜 RealMinePAPI — это плагин, который автоматически форматирует сообщения игроков на основе их групп (через LuckPerms), а также заменяет «пустые» плейсхолдеры на кастомные фразы.
